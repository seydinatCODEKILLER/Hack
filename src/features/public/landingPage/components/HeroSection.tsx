  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce z-10">
        <div className="w-6 h-10 border-2 border-gray-700/80 rounded-full flex justify-center shadow-sm bg-white">
          <div className="w-1 h-3 bg-gray-700 rounded-full mt-2" />
        </div>
      </div>
    </section>
  );
